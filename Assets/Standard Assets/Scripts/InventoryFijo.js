...
private var playersInvDisplay : InventoryDisplayFijo; //Keep track of the InventoryDisplay script.
//private var playersInvDisplayFijo : InventoryFijo;
...
function Awake ()
{
	...
	playersInvDisplay = GetComponent(InventoryDisplayFijo);
	//playersInvDisplayFIjo = GetComponent(InventoryFijo);
